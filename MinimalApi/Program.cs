...
using MinimalApi.HttpClientHelpers;
using MinimalApi.Middleware;
using MinimalApi.Models;
using MinimalApi.Repos;
using MinimalApi.RouteExtensions;
...
builder.Services.AddHttpClient<HttpClientHelper>(c => c.BaseAddress = new Uri("http://localhost:5146"));
